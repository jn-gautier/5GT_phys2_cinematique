...
\begin{figure}[!ht]
    \centering
    \resizebox{.7\linewidth}{!}{\input{./tikz/position_repere.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{.6\linewidth}{!}{\input{./tikz/trajectoire_papillon.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{.6\linewidth}{!}{\input{./tikz/deplacement_papillon.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{0.8\linewidth}{!}{\input{./tikz/vecteur_position.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{0.8\linewidth}{!}{\input{./tikz/vecteur_deplacement.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{0.8\linewidth}{!}{\input{./tikz/repere_exe.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{0.8\linewidth}{!}{\input{./tikz/vitesse_tangente.tikz}}
...
\begin{figure}[!ht]
    \centering
    \resizebox{\linewidth}{!}{\input{./tikz/analyse_deplacement.tikz}}
...
\begin{enumerate}
    \item Le graphique ci-dessous représente la trajectoire d'un mobile. Représente l'allure du vecteur vitesse à différents moments de ce mouvement.
          \begin{figure}[!ht]
              \centering
              \resizebox{.8\linewidth}{!}{\input{./tikz/exercice_vecteur_vitesse.tikz}}
